define('ghost-admin/tests/acceptance/authentication-test', ['exports', 'mocha', 'chai', 'ember', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ember-cli-mirage', 'ghost-admin/utils/window-proxy', 'ghost-admin/utils/ghost-paths'], function (exports, _mocha, _chai, _ember, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _emberCliMirage, _ghostAdminUtilsWindowProxy, _ghostAdminUtilsGhostPaths) {
    ...
    (0, _mocha.describe)('Acceptance: Authentication', function () {
        ...
        (0, _mocha.describe)('editor', function () {
            var origDebounce = run.debounce;
            var origThrottle = run.throttle;
...
define('ghost-admin/tests/helpers/file-upload', ['exports', 'ember'], function (exports, _ember) {
    ...
    exports['default'] = Test.registerAsyncHelper('fileUpload', function (app, selector, content, options) {
        var file = createFile(content, options);
...
/* global Blob */
define('ghost-admin/tests/helpers/module-for-acceptance', ['exports', 'qunit', 'ember', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app'], function (exports, _qunit, _ember, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp) {
...
define('ghost-admin/tests/integration/components/gh-feature-flag-test', ['exports', 'chai', 'ember-mocha', 'ember', 'ember-test-helpers/wait'], function (exports, _chai, _emberMocha, _ember, _emberTestHelpersWait) {
    ...
    var featureStub = Service.extend({
        testFlag: true
    });
...
define('ghost-admin/tests/integration/components/gh-image-uploader-test', ['exports', 'ember', 'sinon', 'chai', 'ember-mocha', 'pretender', 'ember-test-helpers/wait', 'ghost-admin/tests/helpers/file-upload'], function (exports, _ember, _sinon, _chai, _emberMocha, _pretender, _emberTestHelpersWait, _ghostAdminTestsHelpersFileUpload) {
    ...
    var configStub = Service.extend({
        fileStorage: true
    });

    var sessionStub = Service.extend({
...
define('ghost-admin/tests/integration/components/gh-navigation-test', ['exports', 'chai', 'ember-mocha', 'ember', 'ghost-admin/models/navigation-item'], function (exports, _chai, _emberMocha, _ember, _ghostAdminModelsNavigationItem) {
    ...
    (0, _emberMocha.describeComponent)('gh-navigation', 'Integration: Component: gh-navigation', {
        ...
        (0, _emberMocha.it)('triggers reorder action', function () {
            ...
            expectedNewIndex = 0;
            run(function () {
                $(_this.$('.gh-blognav-item')[1]).simulateDragSortable({
                    move: -1,
...
define('ghost-admin/tests/integration/components/gh-tag-settings-form-test', ['exports', 'chai', 'ember-mocha', 'ember', 'ember-data'], function (exports, _chai, _emberMocha, _ember, _emberData) {
    ...
    var mediaQueriesStub = Service.extend({
        maxWidth600: false
    });
    ...
    (0, _emberMocha.describeComponent)('gh-tag-settings-form', 'Integration: Component: gh-tag-settings-form', {
        ...
        (0, _emberMocha.it)('resets if a new tag is received', function () {
            ...
            run(function () {
                _this7.set('tag', EmberObject.create({ id: '2' }));
            });
...
/* jshint expr:true */
define('ghost-admin/tests/integration/components/gh-trim-focus-input-test', ['exports', 'chai', 'ember-mocha', 'ember'], function (exports, _chai, _emberMocha, _ember) {
    var run = _ember['default'].run;
        ...
        (0, _emberMocha.it)('does not have the autofocus attribute if not set to focus', function () {
            ...
            this.render(_ember['default'].HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-trim-focus-input', [['get', 'text', ['loc', [null, [1, 22], [1, 26]]]]], ['focus', false], ['loc', [null, [1, 0], [1, 40]]]]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('has the autofocus attribute if set to focus', function () {
            ...
            this.render(_ember['default'].HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-trim-focus-input', [['get', 'text', ['loc', [null, [1, 22], [1, 26]]]]], ['focus', true], ['loc', [null, [1, 0], [1, 39]]]]],
                    locals: [],
                    templates: []
                };
            })()));
...
define('ghost-admin/tests/integration/components/gh-validation-status-container-test', ['exports', 'chai', 'ember-mocha', 'ember', 'ember-data'], function (exports, _chai, _emberMocha, _ember, _emberData) {
    ...
    (0, _emberMocha.describeComponent)('gh-validation-status-container', 'Integration: Component: gh-validation-status-container', {
        ...
        beforeEach(function () {
            var testObject = EmberObject.create();
...
/* jshint expr:true */
define('ghost-admin/tests/integration/components/main-analytics-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('main-analytics', 'Integration: MainAnalyticsComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'main-analytics', ['loc', [null, [1, 0], [1, 18]]]]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('ghost-admin/tests/integration/components/main-analytics-theme-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeComponent)('main-analytics-theme', 'Integration: MainAnalyticsThemeComponent', {
    integration: true
  }, function () {
    (0, _emberMocha.it)('renders', function () {
      // Set any properties with this.set('myProperty', 'value');
      ...
      this.render(Ember.HTMLBars.template((function () {
        return {
          ...
          statements: [['content', 'main-analytics-theme', ['loc', [null, [1, 0], [1, 24]]]]],
          locals: [],
          templates: []
        };
      })()));
...
/* jshint expr:true */
define('ghost-admin/tests/unit/controllers/highcharts-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeModule)('controller:highcharts', 'HighchartsController', {
    // Specify the other units that are required for this test.
        ...
        describe('updateSlug', function () {
            ...
            (0, _emberMocha.it)('should not set a new slug if the server-generated slug matches existing slug', function (done) {
                var controller = this.subject({
                    slugGenerator: EmberObject.create({
                        generateSlug: function generateSlug(slugType, str) {
                            var promise = RSVP.resolve(str.split('#')[0]);
                ...
                var controller = this.subject({
                    slugGenerator: EmberObject.create({
                        generateSlug: function generateSlug(slugType, str) {
                            ...
                            var promise = RSVP.resolve(sanitizedStr + '-2');
                            this.set('lastPromise', promise);
                            return promise;
                        }
                    }),
...
/* jshint expr:true */
define('ghost-admin/tests/unit/helpers/gh-format-time-scheduled-test', ['exports', 'ember', 'chai', 'mocha', 'ghost-admin/helpers/gh-format-time-scheduled', 'sinon'], function (exports, _ember, _chai, _mocha, _ghostAdminHelpersGhFormatTimeScheduled, _sinon) {
    var EmberObject = _ember['default'].Object;
...
define('ghost-admin/tests/unit/mixins/infinite-scroll-test', ['exports', 'chai', 'mocha', 'ember', 'ghost-admin/mixins/infinite-scroll'], function (exports, _chai, _mocha, _ember, _ghostAdminMixinsInfiniteScroll) {
    ...
    (0, _mocha.describe)('Unit: Mixin: infinite-scroll', function () {
        // Replace this with your real tests.
        (0, _mocha.it)('works', function () {
            var InfiniteScrollObject = EmberObject.extend(_ghostAdminMixinsInfiniteScroll['default']);
...
/* jshint expr:true */
define('ghost-admin/tests/unit/models/high-charts-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeModel)('high-charts', 'Unit | Model | high charts', {
    // Specify the other units that are required for this test.
    needs: []
  }, function () {
    // Replace this with your real tests.
...
define('ghost-admin/tests/unit/models/post-test', ['exports', 'ember', 'ember-mocha'], function (exports, _ember, _emberMocha) {
    ...
    (0, _emberMocha.describeModel)('post', 'Unit: Model: post', {
        ...
        (0, _emberMocha.it)('isAuthoredByUser is correct', function () {
            ...
            /* jscs:enable requireCamelCaseOrUpperCaseIdentifiers */
            var user = EmberObject.create({ id: '15' });
...
define('ghost-admin/tests/unit/routes/about-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeModule)('route:about', 'AboutRoute', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  }, function () {
    (0, _emberMocha.it)('exists', function () {
...
/* jshint expr:true */
define('ghost-admin/tests/unit/routes/analytics-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeModule)('route:analytics', 'AnalyticsRoute', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  }, function () {
    (0, _emberMocha.it)('exists', function () {
...
/* jshint expr:true */
define('ghost-admin/tests/unit/routes/high-charts-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

  (0, _emberMocha.describeModule)('route:high-charts', 'HighChartsRoute', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  }, function () {
    (0, _emberMocha.it)('exists', function () {
...
define('ghost-admin/tests/unit/services/config-test', ['exports', 'chai', 'ember-mocha', 'ember'], function (exports, _chai, _emberMocha, _ember) {
    ...
    (0, _emberMocha.describeModule)('service:config', 'Unit: Service: config', {}, function () {
        ...
        (0, _emberMocha.it)('correctly parses a client secret', function () {
            $('<meta>').attr('name', 'env-clientSecret').attr('content', '23e435234423').appendTo('head');
...
define('ghost-admin/tests/unit/services/notifications-test', ['exports', 'ember', 'sinon', 'chai', 'ember-mocha', 'ember-ajax/errors'], function (exports, _ember, _sinon, _chai, _emberMocha, _emberAjaxErrors) {
    ...
    (0, _emberMocha.describeModule)('service:notifications', 'Unit: Service: notifications', {}, function () {
        ...
        (0, _emberMocha.it)('#handleNotification deals with DS.Notification notifications', function () {
            var notifications = this.subject();
            var notification = EmberObject.create({ message: '<h1>Test</h1>', status: 'alert' });
        ...
        (0, _emberMocha.it)('#closeNotification removes and deletes DS.Notification records', function () {
            var notification = EmberObject.create({ message: 'Close test', status: 'alert' });
            var notifications = this.subject();
        ...
        (0, _emberMocha.it)('#clearAll removes everything without deletion', function () {
            var notifications = this.subject();
            var notificationModel = EmberObject.create({ message: 'model' });
...
define('ghost-admin/tests/unit/validators/tag-settings-test', ['exports', 'chai', 'mocha', 'sinon', 'ember', 'ghost-admin/mixins/validation-engine'], function (exports, _chai, _mocha, _sinon, _ember, _ghostAdminMixinsValidationEngine) {
    ...
    var Tag = EmberObject.extend(_ghostAdminMixinsValidationEngine['default'], {
        validationType: 'tag',
...
define('ghost-admin/tests/units/charts/analytics-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('analytics', 'analytics', {
